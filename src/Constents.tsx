import { capricornImages, capricornThumb, cardamom, cycling, geminiCImages, geminiImages, geminiThumb, indoor, orionImages, orionThumb, taurusImages, taurusThumb, teaWalk, walkImg } from "./Images"
